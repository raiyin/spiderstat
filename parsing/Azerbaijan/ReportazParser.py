...
class ReportazParser:
    ...
    def parse(self, url):
        try:
            ...
            message = self.logger.make_message("ReportazParser", e, url)
...
if __name__ == "__main__":
    ...
    #success, article = my_parser.parse('https://report.az/ru/individual-nye/gyunaj-mamedzade-stala-chempionom'
    #                                   '-azerbajdzhana/')
