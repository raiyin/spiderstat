...
class MisraParser:
    ...
    def parse(self, url):
        try:
            ...
            message = self.logger.make_message_link("MisraParser", e, url)
...
if __name__ == "__main__":
    ...
    my_parser = MisraParser(logger)
    # success, article = my_parser.parse('http://misra.ru/shaxverdiev/')
    success, article = my_parser.parse('http://misra.ru/freedom-house/')
    print(article)
