...
class OnenewsazParser:
    ...
    def parse(self, url):
        try:
            ...
            message = self.logger.make_message_link("OnenewsazParser", e, url)
...
if __name__ == "__main__":
    ...
    # success, article = my_parser.parse('http://www.1news.az/news/pozicii-vs-azerbaydzhana-obstrelyali-s-territorii
    # -armenii')
