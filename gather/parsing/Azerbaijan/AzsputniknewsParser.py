...
class AzsputniknewsParser:
    ...
    def parse(self, url):
        try:
            ...
            message = self.logger.make_message_link("AzsputniknewsParser", e, url)
...
if __name__ == "__main__":
    ...
    # success, article = my_parser.parse('https://az.sputniknews.ru/science/20190217/419459168/dinozavry-okamenelosti
    # -mingjachevir.html')
    success, article = my_parser.parse('https://az.sputniknews.ru/incidents/20190217/419459741/sankt-peterburg'
                                       '-universitet-obrushenie-prichina.html')
    print(article)
